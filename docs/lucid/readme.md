...
Lucid Lite is an experimental front end for Lucid, a language for
programming network data planes (github.com/princetonuniversity/lucid).
This page is its compiler and interpreter, compiled to JavaScript, so
